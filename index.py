...
app.config['SQLALCHEMY_DATABASE_URI']='mysql://admin:connie70247790@database-libro.ccce6rcegxev.us-east-1.rds.amazonaws.com/acadeExamen'
...
#dato1 = Libro(nombre='Yawar Fiesta')
#db.session.add(dato1)
...
#ingresando datos a autor
#dato3= Autor(nombre='Connie', libro_id='1')
#db.session.add(dato3)
